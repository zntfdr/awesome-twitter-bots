...
- [peaceful forest bot](https://twitter.com/@forestgen) - Word based, unique peaceful emoji forest
...
## Comedy 😂
- [Asking For A Friend](https://twitter.com/@AskingFriend) - Questions..asked for a friend. Real tweets from real people
...
- [Pokémon GO Events](https://twitter.com/@pokemongoappEV) - Coundown timer for all the Pokemon Go events
- [The Sorting Hat Bot](https://twitter.com/@SortingBot) 🔥🔥🔥 - Ever seen harry potter? The Sorting Hat is real and it's right here on Twitter
...
- [Robots Rule](https://twitter.com/@RobotzRule) 🔥 - Retweets stories about robots
...
- [DO THINGS BOT](https://twitter.com/@DOTHINGSBOT) 🔥🔥 - Let this bot give you healthy suggestions every hour
- [hydration time!!](https://twitter.com/@hydratebot) 🔥 - Reminds you to drink every hour
- [MAN PRODUCTS](https://twitter.com/@man_products) 🔥 - PRODUCTS FOR MEN!!
- [~*ladyproducts*~](https://twitter.com/@lady_products) 🔥 - Products for ladies

### Music
- [My Favorite Things](https://twitter.com/@FavThingsBot) - Hilarious spin on “My Favorite Things,” the ever popular song from The Sound of Music
- [We Didn't Start It](https://twitter.com/@we_didnt_start) - Transforms Google Trends into new verses of Billy Joel’s 1989 song “We Didn’t Start the Fire”
...
## Technology 👨🏻‍💻
### AI
- [Deep Question Bot](https://twitter.com/@deepquestionbot) - Deep, difficult, and sometimes trivial questions. Based on information contained in ConceptNet
- [Library of Emoji](https://twitter.com/@libraryofemoji) - Speculations about what emoji might appear in upcoming Unicode versions
- [olivia taters](https://twitter.com/@oliviataters) 🔥🔥 - She a teenager, created while experimenting with language manipulation of real-life teenage Twitter accounts

### Apple
- [IPSW Downloads](https://twitter.com/@iosreleases) 🔥🔥🔥 - Tweets about the latest iOS and iTunes releases as they happen
- [TSS Signing Status](https://twitter.com/@TSSStatus) 🔥🔥 - Real-time updates for TSS Signing Status changes
- [ Events Countdown](https://twitter.com/@AppleEventsCD) - Apple events countdown
...
- [blah future](https://twitter.com/@blahfuture) - A disappointed bot, complaining about the present and past promises
